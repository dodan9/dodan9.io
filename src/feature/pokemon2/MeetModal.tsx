...
const MeetModal = ({ url, closeFunction }: propsType) => {
  ...
  const getLocationAreaApi = useEffectEvent(async () => {
    try {
  ...
  const getMyPokemon = useEffectEvent(() => {
    try {
              ...
              {catchOrRun ? (
                catchOrRun === "run" ? (
                  ...
                  <p>
                    ...
                    <Link to="/pokemon2/mypokemon">My Pokemon Box!</Link>
                  </p>
                ) : (
                  <p>
                    can't catch more...
                    <br />
                    go to <Link to="/pokemon2/mypokemon">My Pokemon Box!</Link>
                  </p>
                )
              ) : null}
              {isImgLoading ? (
